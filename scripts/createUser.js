...
async function main() {
  const [deployer, manager, simpleUser, anotherUser] =
  ...
  const username = await askQuestion("User's Name: ");
  //   const userAddress = await askQuestion("User's Address: ");
  ...
  try {
    ...
    console.log("⛔ Something went wrong... | The Error: ");
    console.log();
    console.log("-----------------------------------------------------------");
    console.log();
    console.log(error);
