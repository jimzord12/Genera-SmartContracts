...
async function main() {
  ...
  const address = await askForUser("Provide Address: ");
  // const amountToGive = await askForAmount("Amount in MGS: ");

  try {
    console.log("-----------------------------------------------------------");
    console.log();
    console.log(`====== Commencing MGS Token Balance Retrieval ======`);

    console.log();
    console.log("-----------------------------------------------------------");
    const balance = await ERC20ContractInstance.balanceOf(address);
    console.log("-----------------------------------------------------------");
    console.log("Conserning This Address: ", address);
    console.log("-----------------------------------------------------------");
    console.log();

    console.log("| MGS Balance: ", formatTokenAmount(balance), "  MGS");
    console.log("-----------------------------------------------------------");
    console.log();
  } catch (error) {
    console.log();
